...
tags = ['html', 'body', 'head', 'link', 'meta', 'style', 'div', 'p', 'form', 'legend',
...
class PyH(Tag):
    ...
    def addMeta_charset(self, *arg):
        for f in arg: self.head += meta(charset=f)

    def addMeta(self, *args):
        self.head += meta(name=args[0], content=args[1])
